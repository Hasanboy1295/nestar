...
export class MemberResolver {
	...
	public async updateMember(
		...
		@AuthMember('_id') memberId: ObjectId,//Paranetr memberid tepadagi id yani auth bolgan member un =
	): Promise<Member> {
	...
	public async imagesUploader(
		...
		const promisedList = files.map(async (img: Promise<FileUpload>, index: number): Promise<Promise<void>> => {
			try {
				...
				uploadedImages[index] = url; //Ketma ketlikni saqlash uchun index ga urlni paaste qilayabmiz
			} catch (err) {
