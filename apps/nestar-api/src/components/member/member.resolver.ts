...
export class MemberResolver {
    ...
    @UseGuards(WithoutGuard)
    @Query(() => Members)
    public async getAgents(@Args('input') input: AgentsInquary, @AuthMember('_id') memberId: ObjectId): Promise<Members> {
    ...
    @Query(()=> Members)
    public async getAllMemberByAdmin(@Args('input') input: MembersInquary): Promise<Members>{
